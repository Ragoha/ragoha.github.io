...
| **@EnableWebSecurity** | `@EnableWebSecurity`을 보면 WebSecurityConfiguration.class, SpringWebMvcImportSelector.class, OAuth2ImportSelector.class, HttpSecurityConfiguration.class들을 import해서 실행한다.<br />이 어노테이션을 쓸 경우 @Configuration을 생략해도 된다. |
